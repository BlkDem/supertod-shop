...
<div id="content">
  ...
  <div class="container-fluid">
		    ...
		    <table id="module" class="table table-striped table-bordered table-hover">
			  <thead>
			    <tr>
				  ...
				  <td class="text-center"><?php echo $entry_cost; ?></td>
				  <td class="text-center"><?php echo $entry_tax_class; ?></td>
				  <td class="text-center"><?php echo $entry_geo_zone; ?></td>
	...
	copyright &copy; <a href="mailto:ruslan.shv@gmail.com">Ruslan Shvarev</a><br>
	adapted for OpenCart 2.3, ocStore 2.3 and etc by <a href="mailto:gromov_ky@mail.ru">Kirill Gromov</a>
  </div>
</div>
